 ...
 *      -------------------------------------------------------------------
 *      |                         |                                       |
 *  GenericApplicationContext   AnnotationConfigApplicationContext   WebApplicationContext
 *  
 *  => 컨테이너 종료
 *  
 ...
 *    	Object obj=className.newInstance(); 메모리 할당
 *    	map.put(id.obj) => 저장
 *    -------------------------
...
public class Sawon implements InitializingBean,DisposableBean,BeanNameAware,BeanFactoryAware{
	...
	public void setSex(String sex) {
		this.sex = sex;
		System.out.println("2. setSex()을 호출 : sex값을 채워준다(주입=DI)=> setSex("+sex+")");
	}
	...
	public void setBeanName(String name) {
		// TODO Auto-generated method stub
		System.out.println("setBeanName() Call..:"+name); // app.getBean
	}
