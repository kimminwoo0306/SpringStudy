...
<%--
	  ...
	  beforeMount() : 가상 돔(임시 저장장소) => HTML을 올리기 전 상태
	  ...
	  ==============================> state / props (변경이 안되는 변수) => 속성값 properties
	                                  -----유지 변수(변경이 가능)
...
<body>
	...
	new Vue({
		...
		beforeCreate:function(){
			console.log("beforeCreate Call: 인스턴스 초기화전 상태 : 이벤트 등록..")
			// componentWillCreate()
		},
		created:function(){
		...
		mounted:function(){
			console.log("mounted Call: HTML을 저장할 가상 메모리 저장 완료 : 실제 돔 비교 => 브라우저 출력...")
			// componentDidMount()
			// 다른 라이브러리 연동 => Ajax, Jquery..
		},
		...
		destroyed:function(){
			console.log("destroyd Call: 메모리 해제 상태 ...")
		}
	})
	</script>
</body>
